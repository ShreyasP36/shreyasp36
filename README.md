![Banner](https://github.com/ShreyasP36/shreyasp36/blob/main/Hello%20world!.gif)

## **Shreyas Prasad**

I'm **Shreyas** from India, a SW QA Engineer - Associate at Siemens Digital Industries Software, ensuring the reliability and performance of engineering simulation software like Hypermesh. I specialize in testing, automation, and workflow optimization. I'm also exploring new machine learning algorithms and data science concepts to strengthen my ability to solve diverse projects effectively.

💻 Skilled in Python for data processing, automation, and scripting. 
